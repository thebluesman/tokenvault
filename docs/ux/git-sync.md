...
**Builds on:** `docs/ux/local-editor.md` (Phase 4) and `docs/ux/apply-and-drift.md` (Phase 5) — same panel — **minimum 400px wide, resizable** since issue #35 (`panel-size-and-swatches.md` §3) — same vocabulary. Read both first; this doc extends them and does not restate them.
